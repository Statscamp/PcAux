...
PcAuxData$methods(
    ...
    setMinItemPredCor   = function(x) { minItemPredCor   <<- x                         },
    setMinPcPredCor     = function(x) { minPcPredCor     <<- x                         },
    setMinPcPredCount   = function(x) { minPcPredCount   <<- x                         },
    ...
    getMinItemPredCor   = function()  { minItemPredCor                         },
    getMinPcPredCor     = function()  { minPcPredCor                           },
    getMinPcPredCount   = function()  { minPcPredCount                         },
